...
const load_perspective = require("../obj/psp.wasm.node").load_perspective;
...
const perspective = createRuntime(load_perspective({
    wasmBinary: buffer,
    wasmJSMethod: "native-wasm",
    ENVIRONMENT: "NODE"
}));
delete perspective["worker"];
 ...
 */
class WebSocketHost extends perspective.Host {
    ...
    open(name, data, options) {
        this._tables[name] = perspective.table(data, options);
    }
}
